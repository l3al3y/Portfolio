...
1. **Hybrid Self-Checkout System using Barcode Scanner & Camera (Computer Vision)**  
   *Capstone Project*  
   * Tech Stack: Python, OpenCV, YOLOv8 (trained 50 epochs), USB Barcode Scanner, MySQL.  
   * Performance: **77.4% Precision**, **72.0% Recall**, dual-verification cross-referencing logic, **<150ms inference latency**.
...
* **Third Place** | *INOTEK 2025 Innovation & Technology Competition Series 1* (15 Jan 2025)
* **Silver Medal** | *Pertandingan Rekacipta dan Inovasi Pelajar 2018* - Smart Attendance & Lecturer Tracking System (10-11 Oct 2018)
* **Best Student Award** | *Kolej Komuniti Selandar* (March 2018 Session)
* **Outstanding Achievement in Subject** | *Kolej Komuniti Selandar* (Nov 2017 Session)
